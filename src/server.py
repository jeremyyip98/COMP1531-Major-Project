...
def http_invite():
    """This route invite a person to channel"""
...
def http_details():
    """This route show the details of channel"""
...
def http_messages():
    """Shows all of the messages from the current channel"""
...
def http_sethandle():
    """Set the handle in user profile"""
    payload = request.get_json()
    token = payload["token"]
